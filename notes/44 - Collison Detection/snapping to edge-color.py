...
def main():
   ...
   #-----------------------------Main Game Loop----------------------------------------#
    while True:
        ...
        #Pick a ground level based on color
        detectionCoord = (circlePosX,circlePosY+circleSize)
        colorBelow = mainSurface.get_at(detectionCoord)


        if colorBelow == (200,200,200,255):
            groundLevel = detectionCoord[1]-1
        else:
            groundLevel = surfaceSize
      
#         print(groundLevel, detectionCoord, colorBelow)
        ...
        #Draw the ground
        pygame.draw.rect(mainSurface,(200,200,200), (0,400,surfaceSize,surfaceSize-400))
        #Draw the Circle
